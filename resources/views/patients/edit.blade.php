        ...
        <form class="p-3 border border-primary rounded" action="/patients/{{ $patient->id }}/edit" method="POST">
            ...
            <div class="form-row d-flex justify-content-between mb-3">
                ...
                <div class="form-group">
                    ...
                    @if ($errors->has('second_name'))
                        <div>{{ $errors->first('second_name') }}</div>
                    @endif
                </div>
                <div class="form-group">
                    ...
                    @if ($errors->has('first_surname'))
                        <div>{{ $errors->first('first_surname') }}</div>
                    @endif
                </div>
                <div class="form-group">
                    ...
                    @if ($errors->has('second_surname'))
                        <div>{{ $errors->first('second_surname') }}</div>
                    @endif
                </div>
            </div>
            <div class="form-row d-flex justify-content-between mb-3">
                ...
                <div class="form-group">
                    ...
                    @if ($errors->has('identification_number'))
                        <div>{{ $errors->first('identification_number') }}</div>
                    @endif
                </div>
                <div class="form-group">
                    ...
                    @if ($errors->has('birthday_date'))
                        <div>{{ $errors->first('birthday_date') }}</div>
                    @endif
                </div>
            </div>
            ...
            <div class="form-row d-flex justify-content-between mb-3">
                <div class="col-4 form-group">
                    ...
                    <input type="text" class="form-control" name="address_1" value="{{ $patient->additional_info->address_1 }}">
                    @if ($errors->has('address_1'))
                        <div>{{ $errors->first('address_1') }}</div>
                    @endif
                </div>
                <div class="col-4 form-group">
                    <label for="address_2">Direccion 2</label>
                    <input type="text" class="form-control" name="address_2" value="{{ $patient->additional_info->address_2 }}"">
                    @if ($errors->has('address_2'))
                        <div>{{ $errors->first('address_2') }}</div>
                    @endif
                </div>
            </div>
            <hr size="10" class="mt-0">
